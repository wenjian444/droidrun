<Warning>
<b>Help Us Improve DroidRun!</b><br/>
We rely on anonymized telemetry to understand how DroidRun is used and to make it better for <b>you</b>. Telemetry data is <b>never</b> used for tracking individuals and is only collected to improve the framework in the areas that matter most to our users. Disabling telemetry may limit our ability to prioritize features and fix issues that affect you. Thank you for helping us build a better DroidRun!
</Warning>
...
DroidRun collects <b>anonymized usage data</b> to help us understand which features are most valuable and where improvements are needed. This data is <b>never</b> used for advertising or tracking individuals, and is only used to make DroidRun better for the community.
